 ...
 * @return {JSX.Element} Rendered social icon with a link
 */
const SocialIcon = ({ href, iconPath, title }) => (
	<Link
		href={href}
		className="transition-all p-2 group duration-500 bg-white/5 rounded-full border border-white/10 hover:scale-110 hover:border-white/50"
	>
		<svg
			className="duration-500 fill-zinc-500 group-hover:fill-white/90"
			width="15"
			height="15"
			viewBox="0 0 24 24"
...
const Header = () => {
	...
	// Add additional social links such as `medium.com` and `dev.to`
